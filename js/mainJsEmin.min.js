!function (t, e) {
	...
	function a() {
		ft.addEventListener ? (ft.removeEventListener("DOMContentLoaded", r, !1),
			t.removeEventListener("load", r, !1)) : (ft.detachEvent("onreadystatechange", r),
	...
	function u(t, e, i, n) {
		if (st.acceptData(t)) {
			var s, o, a = st.expando, r = t.nodeType, l = r ? st.cache : t, h = r ? t[a] : t[a] && a;
			if (h && l[h] && (n || l[h].data) || void 0 !== i || "string" != typeof e)
				return h || (h = r ? t[a] = K.pop() || st.guid++ : a),
					l[h] || (l[h] = r ? {} : {
						toJSON: st.noop
					}),
					...
					"string" == typeof e ? null == (s = o[e]) && (s = o[st.camelCase(e)]) : s = o,
					s
		}
	}
	function c(t, e, i) {
		if (st.acceptData(t)) {
			var n, s, o = t.nodeType, a = o ? st.cache : t, r = o ? t[st.expando] : st.expando;
			if (a[r]) {
				...
				(i || (delete a[r].data,
					h(a[r]))) && (o ? st.cleanData([t], !0) : it.deleteExpando || a != a.window ? delete a[r] : a[r] = null)
			}
		}
	}
	function d() {
	...
	function g(t, e) {
		var i, n, s = 0, o = typeof t.getElementsByTagName !== wt ? t.getElementsByTagName(e || "*") : typeof t.querySelectorAll !== wt ? t.querySelectorAll(e || "*") : void 0;
		if (!o)
			for (o = [],
	...
	function w(t, e) {
		if (1 === e.nodeType && st.hasData(t)) {
			var i, n, s, o = st._data(t), a = st._data(e, o), r = o.events;
			if (r) {
				delete a.handle,
					a.events = {};
				for (i in r)
	...
	function C(t, e) {
		...
		if (1 === e.nodeType) {
			...
			"script" === i && e.text !== t.text ? (y(e).text = t.text,
				_(e)) : "object" === i ? (e.parentNode && (e.outerHTML = t.outerHTML),
					it.html5Clone && t.innerHTML && !st.trim(e.innerHTML) && (e.innerHTML = t.innerHTML)) : "input" === i && Nt.test(t.type) ? (e.defaultChecked = e.checked = t.checked,
	...
	function k(e, i) {
		var n, s = st(i.createElement(e)).appendTo(i.body), o = t.getDefaultComputedStyle && (n = t.getDefaultComputedStyle(s[0])) ? n.display : st.css(s[0], "display");
		return s.detach(),
			o
	}
	function D(t) {
		var e = ft
			, i = Jt[t];
		return i || (i = k(t, e),
			"none" !== i && i || (Qt = (Qt || st("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement),
				e = (Qt[0].contentWindow || Qt[0].contentDocument).document,
				e.write(),
				e.close(),
				i = k(t, e),
				Qt.detach()),
	...
	function F(t, e) {
		for (var i, n, s, o = [], a = 0, r = t.length; r > a; a++)
			n = t[a],
				n.style && (o[a] = st._data(n, "olddisplay"),
					i = n.style.display,
					e ? (o[a] || "none" !== i || (n.style.display = ""),
						"" === n.style.display && St(n) && (o[a] = st._data(n, "olddisplay", D(n.nodeName)))) : (s = St(n),
							(i && "none" !== i || !s) && st._data(n, "olddisplay", s ? i : st.css(n, "display"))));
		for (a = 0; r > a; a++)
			n = t[a],
	...
	function E(t, e, i, n, s) {
		for (var o = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0, a = 0; 4 > o; o += 2)
			"margin" === i && (a += st.css(t, i + Tt[o], !0, s)),
				n ? ("content" === i && (a -= st.css(t, "padding" + Tt[o], !0, s)),
					"margin" !== i && (a -= st.css(t, "border" + Tt[o] + "Width", !0, s))) : (a += st.css(t, "padding" + Tt[o], !0, s),
						"padding" !== i && (a += st.css(t, "border" + Tt[o] + "Width", !0, s)));
		return a
	}
	function I(t, e, i) {
		var n = !0
		...
		return s + E(t, e, i || (a ? "border" : "content"), n, o) + "px"
	}
	...
	function H(t, e, i) {
		for (var n, s = (be[e] || []).concat(be["*"]), o = 0, a = s.length; a > o; o++)
			if (n = s[o].call(i, e, t))
				return n
	}
	function z(t, e, i) {
		var n, s, o, a, r, l, h, u = this, c = {}, d = t.style, p = t.nodeType && St(t), f = st._data(t, "fxshow");
		i.queue || (r = st._queueHooks(t, "fx"),
			...
			1 === t.nodeType && ("height" in e || "width" in e) && (i.overflow = [d.overflow, d.overflowX, d.overflowY],
				h = st.css(t, "display"),
				"inline" === ("none" === h ? st._data(t, "olddisplay") || D(t.nodeName) : h) && "none" === st.css(t, "float") && (it.inlineBlockNeedsLayout && "inline" !== D(t.nodeName) ? d.zoom = 1 : d.display = "inline-block")),
			i.overflow && (d.overflow = "hidden",
				it.shrinkWrapBlocks() || u.always(function () {
		...
		for (n in e)
			if (s = e[n],
				...
				c[n] = f && f[n] || st.style(t, n)
			} else
				h = void 0;
		if (st.isEmptyObject(c))
			"inline" === ("none" === h ? D(t.nodeName) : h) && (d.display = h);
		else {
			f ? "hidden" in f && (p = f.hidden) : f = st._data(t, "fxshow", {}),
				o && (f.hidden = !p),
				p ? st(t).show() : u.done(function () {
					st(t).hide()
				}),
				u.done(function () {
					var e;
	...
	function W(t, e, i) {
		var n, s, o = 0, a = ve.length, r = st.Deferred().always(function () {
			delete l.elem
		}), l = function () {
			if (s)
				return !1;
			for (var e = de || M(), i = Math.max(0, h.startTime + h.duration - e), n = i / h.duration || 0, o = 1 - n, a = 0, l = h.tweens.length; l > a; a++)
				h.tweens[a].run(o);
			return r.notifyWith(t, [h, o, i]),
				1 > o && l ? i : (r.resolveWith(t, [h]),
					!1)
		}, h = r.promise({
			elem: t,
			props: st.extend({}, e),
		...
		for (O(u, h.opts.specialEasing); a > o; o++)
			if (n = ve[o].call(h, t, u, h.opts))
				return n;
		return st.map(u, H, h),
	...
	function $(t, e, i, n) {
		...
		if (st.isArray(e))
			st.each(e, function (e, s) {
				i || Ye.test(t) ? n(t, s) : $(t + "[" + ("object" == typeof s ? e : "") + "]", s, i, n)
			});
			...
			for ("boolean" == typeof a && (h = a,
				...
				if (null != (s = arguments[r]))
					for (n in s)
						t = a[n],
							i = s[n],
							a !== i && (h && i && (st.isPlainObject(i) || (e = st.isArray(i))) ? (e ? (e = !1,
								o = t && st.isArray(t) ? t : []) : o = t && st.isPlainObject(t) ? t : {},
		...
		st.extend({
			...
			proxy: function (t, e) {
				...
				return "string" == typeof e && (s = t[e],
					e = t,
					t = s),
					st.isFunction(t) ? (i = V.call(arguments, 2),
						n = function () {
	...
	var ht = function (t) {
		function e(t, e, i, n) {
			var s, o, a, r, h, c, d, p, f, m;
			if ((e ? e.ownerDocument || e : W) !== E && N(e),
				e = e || E,
				i = i || [],
				r = e.nodeType,
			...
			if (!n && A) {
				if (11 !== r && (s = gt.exec(t)))
					if (a = s[1]) {
						if (9 === r) {
							if (!(o = e.getElementById(a)) || !o.parentNode)
								return i;
							if (o.id === a)
								return i.push(o),
									i
						...
						if (s[2])
							return G.apply(i, e.getElementsByTagName(t)),
								i;
						if ((a = s[3]) && y.getElementsByClassName)
							return G.apply(i, e.getElementsByClassName(a)),
								i
					}
				if (y.qsa && (!M || !M.test(t))) {
					if (p = d = O,
						...
						for (c = C(t),
							(d = e.getAttribute("id")) ? p = d.replace(bt, "\\$&") : e.setAttribute("id", p),
							p = "[id='" + p + "'] ",
							h = c.length; h--;)
							c[h] = p + u(c[h]);
						f = vt.test(t) && l(e.parentNode) || e,
							m = c.join(",")
					}
					if (m)
						try {
							return G.apply(i, f.querySelectorAll(m)),
								i
						} catch (t) { } finally {
		...
		function m(t, e, i, s, o, a) {
			return s && !s[O] && (s = m(s)),
				o && !o[O] && (o = m(o, a)),
				n(function (n, a, r, l) {
					var h, u, c, d = [], m = [], g = a.length, v = n || p(e || "*", r.nodeType ? [r] : r, []), b = !t || !n && e ? v : f(v, d, t, r, l), y = i ? o || (n ? t : g || s) ? [] : a : b;
					if (i && i(b, y, r, l),
						s)
						for (h = f(y, m),
							s(h, [], r, l),
					...
					if (n) {
						if (o || t) {
							...
							for (u = y.length; u--;)
								(c = y[u]) && (h = o ? J(n, c) : d[u]) > -1 && (n[h] = !(a[h] = c))
						}
					} else
						y = f(y === a ? y.splice(g, y.length) : y),
							o ? o(null, a, y, l) : G.apply(a, y)
				})
		}
		function g(t) {
			for (var e, i, n, s = t.length, o = _.relative[t[0].type], a = o || _.relative[" "], r = o ? 1 : 0, l = c(function (t) {
				return t === e
			}, a, !0), h = c(function (t) {
				return J(e, t) > -1
				...
				if (i = _.relative[t[r].type])
					...
					if (i = _.filter[t[r].type].apply(null, t[r].matches),
						...
						for (n = ++r; s > n && !_.relative[t[n].type]; n++)
							;
						return m(r > 1 && d(p), r > 1 && u(t.slice(0, r - 1).concat({
							value: " " === t[r - 2].type ? "*" : ""
						})).replace(at, "$1"), i, n > r && g(t.slice(r, n)), s > n && g(t = t.slice(n)), s > n && u(t))
					}
					p.push(i)
				}
			return d(p)
		...
		function v(t, i) {
			var s = i.length > 0
				...
				, a = function (n, a, r, l, h) {
					var u, c, d, p = 0, m = "0", g = n && [], v = [], b = T, y = n || o && _.find.TAG("*", h), x = L += null == b ? 1 : Math.random() || .1, w = y.length;
					for (h && (T = a !== E && a); m !== w && null != (u = y[m]); m++) {
						if (o && u) {
							for (c = 0; d = t[c++];)
								if (d(u, a, r)) {
									l.push(u);
		...
		var b, y, _, x, w, C, k, D, T, S, F, N, E, I, A, M, P, H, z, O = "sizzle" + 1 * new Date, W = t.document, L = 0, R = 0, j = i(), q = i(), B = i(), $ = function (t, e) {
			return t === e && (F = !0),
				0
		}, Y = 1 << 31, U = {}.hasOwnProperty, X = [], K = X.pop, V = X.push, G = X.push, Q = X.slice, J = function (t, e) {
			for (var i = 0, n = t.length; n > i; i++)
				if (t[i] === e)
					return i;
			return -1
		}, Z = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", tt = "[\\x20\\t\\r\\n\\f]", et = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", it = et.replace("w", "w#"), nt = "\\[" + tt + "*(" + et + ")(?:" + tt + "*([*^$|!~]?=)" + tt + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + it + "))|)" + tt + "*\\]", st = ":(" + et + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + nt + ")*)|.*)\\)|)", ot = new RegExp(tt + "+", "g"), at = new RegExp("^" + tt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + tt + "+$", "g"), rt = new RegExp("^" + tt + "*," + tt + "*"), lt = new RegExp("^" + tt + "*([>+~]|" + tt + ")" + tt + "*"), ht = new RegExp("=" + tt + "*([^\\]'\"]*?)" + tt + "*\\]", "g"), ut = new RegExp(st), ct = new RegExp("^" + it + "$"), dt = {
			ID: new RegExp("^#(" + et + ")"),
			CLASS: new RegExp("^\\.(" + et + ")"),
		...
		}, pt = /^(?:input|select|textarea|button)$/i, ft = /^h\d$/i, mt = /^[^{]+\{\s*\[native \w/, gt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, vt = /[+~]/, bt = /'|\\/g, yt = new RegExp("\\\\([\\da-f]{1,6}" + tt + "?|(" + tt + ")|.)", "ig"), _t = function (t, e, i) {
			var n = "0x" + e - 65536;
		...
		try {
			G.apply(X = Q.call(W.childNodes), W.childNodes),
		...
		y = e.support = {},
			...
			N = e.setDocument = function (t) {
				...
				return n !== E && 9 === n.nodeType && n.documentElement ? (E = n,
					I = n.documentElement,
					i = n.defaultView,
					i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", xt, !1) : i.attachEvent && i.attachEvent("onunload", xt)),
					A = !w(n),
					...
					P = [],
					M = [],
					(y.qsa = mt.test(n.querySelectorAll)) && (s(function (t) {
						I.appendChild(t).innerHTML = "<a id='" + O + "'></a><select id='" + O + "-\f]' msallowcapture=''><option selected=''></option></select>",
					...
					(y.matchesSelector = mt.test(H = I.matches || I.webkitMatchesSelector || I.mozMatchesSelector || I.oMatchesSelector || I.msMatchesSelector)) && s(function (t) {
						y.disconnectedMatch = H.call(t, "div"),
							H.call(t, "[s!='']:x"),
							P.push("!=", st)
					}),
					...
					z = e || mt.test(I.contains) ? function (t, e) {
					...
					$ = e ? function (t, e) {
						...
						return i || (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1,
							1 & i || !y.sortDetached && e.compareDocumentPosition(t) === i ? t === n || t.ownerDocument === W && z(W, t) ? -1 : e === n || e.ownerDocument === W && z(W, e) ? 1 : S ? J(S, t) - J(S, e) : 0 : 4 & i ? -1 : 1)
					}
						: function (t, e) {
							if (t === e)
								return F = !0,
							...
							if (!o || !r)
								return t === n ? -1 : e === n ? 1 : o ? -1 : r ? 1 : S ? J(S, t) - J(S, e) : 0;
							if (o === r)
								return a(t, e);
							...
							for (; l[s] === h[s];)
								s++;
							return s ? a(l[s], h[s]) : l[s] === W ? -1 : h[s] === W ? 1 : 0
						}
					,
					n) : E
			}
			...
			e.matchesSelector = function (t, i) {
				if ((t.ownerDocument || t) !== E && N(t),
					i = i.replace(ht, "='$1']"),
					!(!y.matchesSelector || !A || P && P.test(i) || M && M.test(i)))
					try {
						var n = H.call(t, i);
			...
			e.contains = function (t, e) {
				return (t.ownerDocument || t) !== E && N(t),
					z(t, e)
			}
			,
			e.attr = function (t, e) {
				...
				var i = _.attrHandle[e.toLowerCase()]
					, n = i && U.call(_.attrHandle, e.toLowerCase()) ? i(t, e, !A) : void 0;
				...
				filter: {
					...
					ATTR: function (t, i, n) {
						return function (s) {
							var o = e.attr(s, t);
							return null == o ? "!=" === i : !i || (o += "",
								"=" === i ? o === n : "!=" === i ? o !== n : "^=" === i ? n && 0 === o.indexOf(n) : "*=" === i ? n && o.indexOf(n) > -1 : "$=" === i ? n && o.slice(-n.length) === n : "~=" === i ? (" " + o.replace(ot, " ") + " ").indexOf(n) > -1 : "|=" === i && (o === n || o.slice(0, n.length + 1) === n + "-"))
						}
					},
							...
							: function (e, i, l) {
								...
								if (g) {
									if (o) {
										for (; m;) {
											for (c = e; c = c[m];)
												if (r ? c.nodeName.toLowerCase() === v : 1 === c.nodeType)
													return !1;
									...
									if (f = [a ? g.firstChild : g.lastChild],
										...
										for (u = g[O] || (g[O] = {}),
											...
											p = h[0] === L && h[1],
											d = h[0] === L && h[2],
											c = p && g.childNodes[p]; c = ++p && c && c[m] || (d = p = 0) || f.pop();)
											if (1 === c.nodeType && ++d && c === e) {
												u[t] = [L, p, d];
												break
											}
									} else if (b && (h = (e[O] || (e[O] = {}))[t]) && h[0] === L)
										d = h[1];
									else
										for (; (c = ++p && c && c[m] || (d = p = 0) || f.pop()) && ((r ? c.nodeName.toLowerCase() !== v : 1 !== c.nodeType) || !++d || (b && ((c[O] || (c[O] = {}))[t] = [L, d]),
											c !== e));)
											;
					...
					PSEUDO: function (t, i) {
						...
						return o[O] ? o(i) : o.length > 1 ? (s = [t, t, "", i],
		...
		return h.prototype = _.filters = _.pseudos,
			...
			C = e.tokenize = function (t, i) {
				var n, s, o, a, r, l, h, u = q[t + " "];
				if (u)
					return i ? 0 : u.slice(0);
				for (r = t,
					l = [],
					h = _.preFilter; r;) {
					(!n || (s = rt.exec(r))) && (s && (r = r.slice(s[0].length) || r),
						l.push(o = [])),
						n = !1,
						(s = lt.exec(r)) && (n = s.shift(),
							o.push({
								value: n,
								type: s[0].replace(at, " ")
							}),
							r = r.slice(n.length));
					for (a in _.filter)
						!(s = dt[a].exec(r)) || h[a] && !(s = h[a](s)) || (n = s.shift(),
							o.push({
								value: n,
								type: a,
								matches: s
			...
			D = e.select = function (t, e, i, n) {
				var s, o, a, r, h, c = "function" == typeof t && t, d = !n && C(t = c.selector || t);
				if (i = i || [],
					1 === d.length) {
					if (o = d[0] = d[0].slice(0),
						o.length > 2 && "ID" === (a = o[0]).type && y.getById && 9 === e.nodeType && A && _.relative[o[1].type]) {
						if (!(e = (_.find.ID(a.matches[0].replace(yt, _t), e) || [])[0]))
							return i;
						c && (e = e.parentNode),
							t = t.slice(o.shift().value.length)
					}
					for (s = dt.needsContext.test(t) ? 0 : o.length; s-- && (a = o[s],
						!_.relative[r = a.type]);)
						if ((h = _.find[r]) && (n = h(a.matches[0].replace(yt, _t), vt.test(o[0].type) && l(e.parentNode) || e))) {
							if (o.splice(s, 1),
								!(t = n.length && u(o)))
								return G.apply(i, n),
									i;
				...
				return (c || k(t, d))(n, e, !A, i, vt.test(t) && l(e.parentNode) || e),
					i
			}
			,
			y.sortStable = O.split("").sort($).join("") === O,
			y.detectDuplicates = !!F,
			N(),
	...
	(st.fn.init = function (t, e) {
		...
		if (!t)
			return this;
		if ("string" == typeof t) {
			if (!(i = "<" === t.charAt(0) && ">" === t.charAt(t.length - 1) && t.length >= 3 ? [null, t, null] : mt.exec(t)) || !i[1] && e)
				return !e || e.jquery ? (e || pt).find(t) : this.constructor(e).find(t);
			if (i[1]) {
				if (e = e instanceof st ? e[0] : e,
					st.merge(this, st.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : ft, !0)),
					ct.test(i[1]) && st.isPlainObject(e))
					for (i in e)
		...
		return t.nodeType ? (this.context = this[0] = t,
			this.length = 1,
			this) : st.isFunction(t) ? void 0 !== pt.ready ? pt.ready(t) : t(st) : (void 0 !== t.selector && (this.selector = t.selector,
	...
	st.extend({
		...
		st.fn.extend({
			...
			closest: function (t, e) {
				for (var i, n = 0, s = this.length, o = [], a = ut.test(t) || "string" != typeof t ? st(t, e || this.context) : 0; s > n; n++)
		...
		st.each({
			...
			st.fn[t] = function (i, n) {
				...
				return "Until" !== t.slice(-5) && (n = i),
					...
					this.length > 1 && (vt[t] || (s = st.unique(s)),
	...
	st.Callbacks = function (t) {
		...
		var e, i, n, s, a, r, l = [], h = !t.once && [], u = function (o) {
			for (i = t.memory && o,
				n = !0,
				a = r || 0,
				r = 0,
		...
		st.extend({
			...
			when: function (t) {
				var e, i, n, s = 0, o = V.call(arguments), a = o.length, r = 1 !== a || t && st.isFunction(t.promise) ? a : 0, l = 1 === r ? t : st.Deferred(), h = function (t, i, n) {
					return function (s) {
						i[t] = this,
				...
				if (a > 1)
					for (e = new Array(a),
						i = new Array(a),
						n = new Array(a); a > s; s++)
						o[s] && st.isFunction(o[s].promise) ? o[s].promise().done(h(s, n, o)).fail(l.reject).progress(h(s, i, e)) : --r;
		...
		st.extend({
			...
			ready: function (t) {
				if (!0 === t ? !--st.readyWait : !st.isReady) {
					...
					st.isReady = !0,
						!0 !== t && --st.readyWait > 0 || (_t.resolveWith(ft, [st]),
							st.fn.triggerHandler && (st(ft).triggerHandler("ready"),
								st(ft).off("ready")))
				}
			}
		}),
		st.ready.promise = function (e) {
			if (!_t)
				if (_t = st.Deferred(),
					...
					ft.addEventListener("DOMContentLoaded", r, !1),
	...
	it.ownLast = "0" !== xt,
		...
		st(function () {
			var t, e, i, n;
			(i = ft.getElementsByTagName("body")[0]) && i.style && (e = ft.createElement("div"),
				...
				typeof e.style.zoom !== wt && (e.style.cssText = "display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1",
	...
	st.extend({
		...
		st.extend({
			queue: function (t, e, i) {
				...
				return t ? (e = (e || "fx") + "queue",
					n = st._data(t, e),
					i && (!n || st.isArray(i) ? n = st._data(t, e, st.makeArray(i)) : n.push(i)),
					n || []) : void 0
			},
		...
		st.fn.extend({
			...
			promise: function (t, e) {
				var i, n = 1, s = st.Deferred(), o = this, a = this.length, r = function () {
					--n || s.resolveWith(o, [o])
				};
				for ("string" != typeof t && (e = t,
					t = void 0),
					t = t || "fx"; a--;)
					(i = st._data(o[a], t + "queueHooks")) && i.empty && (n++ ,
						i.empty.add(r));
				return r(),
					s.promise(e)
			}
	...
	var Dt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source
		...
		, Ft = st.access = function (t, e, i, n, s, o, a) {
			var r = 0
				, l = t.length
				, h = null == i;
			if ("object" === st.type(i)) {
	...
	!function () {
		...
		function () {
			...
			for (e in {
				...
				i = "on" + e,
					(it[e + "Bubbles"] = i in t) || (n.setAttribute(i, "t"),
						it[e + "Bubbles"] = !1 === n.attributes[i].expando);
			n = null
		}();
	...
	st.event = {
			...
			if (g) {
				for (i.handler && (l = i,
					...
					(u = g.handle) || (u = g.handle = function (t) {
						return typeof st === wt || t && st.event.triggered === t.type ? void 0 : st.event.dispatch.apply(u.elem, arguments)
					}
						,
						u.elem = t),
					e = (e || "").match(bt) || [""],
					...
					o = Pt.exec(e[r]) || [],
						...
						p && (h = st.event.special[p] || {},
							...
							(d = a[p]) || (d = a[p] = [],
								d.delegateCount = 0,
								h.setup && !1 !== h.setup.call(t, n, f, u) || (t.addEventListener ? t.addEventListener(p, u, !1) : t.attachEvent && t.attachEvent("on" + p, u))),
			...
			if (g && (u = g.events)) {
				for (e = (e || "").match(bt) || [""],
					...
					if (r = Pt.exec(e[h]) || [],
						...
						l && !d.length && (c.teardown && !1 !== c.teardown.call(t, f, g.handle) || st.removeEvent(t, p, g.handle),
							delete u[p])
					} else
						for (p in u)
							st.event.remove(t, p + e[h], i, n, !0);
				st.isEmptyObject(u) && (delete g.handle,
					st._removeData(t, "events"))
			}
		},
		trigger: function (e, i, n, s) {
			var o, a, r, l, h, u, c, d = [n || ft], p = et.call(e, "type") ? e.type : e, f = et.call(e, "namespace") ? e.namespace.split(".") : [];
			if (r = u = n = n || ft,
				3 !== n.nodeType && 8 !== n.nodeType && !Mt.test(p + st.event.triggered) && (p.indexOf(".") >= 0 && (f = p.split("."),
					p = f.shift(),
					f.sort()),
					a = p.indexOf(":") < 0 && "on" + p,
					e = e[st.expando] ? e : new st.Event(p, "object" == typeof e && e),
					e.isTrigger = s ? 2 : 3,
					e.namespace = f.join("."),
				...
				if (!s && !h.noBubble && !st.isWindow(n)) {
					for (l = h.delegateType || p,
						Mt.test(l + p) || (r = r.parentNode); r; r = r.parentNode)
						d.push(r),
							u = r;
					u === (n.ownerDocument || ft) && d.push(u.defaultView || u.parentWindow || t)
				}
				for (c = 0; (r = d[c++]) && !e.isPropagationStopped();)
					e.type = c > 1 ? l : h.bindType || p,
						o = (st._data(r, "events") || {})[e.type] && st._data(r, "handle"),
						o && o.apply(r, i),
						(o = a && r[a]) && o.apply && st.acceptData(r) && (e.result = o.apply(r, i),
							!1 === e.result && e.preventDefault());
				if (e.type = p,
					!s && !e.isDefaultPrevented() && (!h._default || !1 === h._default.apply(d.pop(), i)) && st.acceptData(n) && a && n[p] && !st.isWindow(n)) {
					u = n[a],
						u && (n[a] = null),
		...
		dispatch: function (t) {
			t = st.event.fix(t);
			var e, i, n, s, o, a = [], r = V.call(arguments), l = (st._data(this, "events") || {})[t.type] || [], h = st.event.special[t.type] || {};
			if (r[0] = t,
				t.delegateTarget = this,
				!h.preDispatch || !1 !== h.preDispatch.call(this, t)) {
				for (a = st.event.handlers.call(this, t, l),
					...
					for (t.currentTarget = s.elem,
						...
						(!t.namespace_re || t.namespace_re.test(n.namespace)) && (t.handleObj = n,
							t.data = n.data,
							void 0 !== (i = ((st.event.special[n.origType] || {}).handle || n.handler).apply(s.elem, r)) && !1 === (t.result = i) && (t.preventDefault(),
								t.stopPropagation()));
		...
		fix: function (t) {
			...
			for (a || (this.fixHooks[s] = a = At.test(s) ? this.mouseHooks : It.test(s) ? this.keyHooks : {}),
		...
		mouseHooks: {
			...
			filter: function (t, e) {
				...
				return null == t.pageX && null != e.clientX && (n = t.target.ownerDocument || ft,
					s = n.documentElement,
					i = n.body,
		...
		st.removeEvent = ft.removeEventListener ? function (t, e, i) {
			...
			: function (t, e, i) {
				var n = "on" + e;
				t.detachEvent && (typeof t[n] === wt && (t[n] = null),
					t.detachEvent(n, i))
			}
		,
		...
		st.each({
			...
			st.event.special[t] = {
				...
				handle: function (t) {
					...
					return (!s || s !== n && !st.contains(n, s)) && (t.type = o.origType,
		...
		it.focusinBubbles || st.each({
			...
			st.event.special[e] = {
				...
				teardown: function () {
					var n = this.ownerDocument || this
						, s = st._data(n, e) - 1;
					s ? st._data(n, e, s) : (n.removeEventListener(t, i, !0),
						st._removeData(n, e))
				}
			}
		}),
	...
	var Ht = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video"
		...
		, Vt = m(ft)
		, Gt = Vt.appendChild(ft.createElement("div"));
	Kt.optgroup = Kt.option,
		...
		st.extend({
			clone: function (t, e, i) {
				...
				if (it.html5Clone || st.isXMLDoc(t) || !Ot.test("<" + t.nodeName + ">") ? o = t.cloneNode(!0) : (Gt.innerHTML = t.outerHTML,
					Gt.removeChild(o = Gt.firstChild)),
					!(it.noCloneEvent && it.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || st.isXMLDoc(t)))
					for (n = g(o),
						r = g(t),
						a = 0; null != (s = r[a]); ++a)
						n[a] && C(s, n[a]);
			...
			buildFragment: function (t, e, i, n) {
					...
					if ((o = t[f]) || 0 === o)
						if ("object" === st.type(o))
							...
							for (r = r || d.appendChild(e.createElement("div")),
								...
								u = Kt[l] || Kt._default,
								r.innerHTML = u[1] + o.replace(Lt, "<$1></$2>") + u[2],
								s = u[0]; s--;)
								r = r.lastChild;
							if (!it.leadingWhitespace && Wt.test(o) && p.push(e.createTextNode(Wt.exec(o)[0])),
								!it.tbody)
								for (o = "table" !== l || jt.test(o) ? "<table>" !== u[1] || jt.test(o) ? 0 : r : r.firstChild,
									s = o && o.childNodes.length; s--;)
									st.nodeName(h = o.childNodes[s], "tbody") && !h.childNodes.length && o.removeChild(h);
							for (st.merge(p, r.childNodes),
				...
				for (r && d.removeChild(r),
					...
					f = 0; o = p[f++];)
					if ((!n || -1 === st.inArray(o, n)) && (a = st.contains(o.ownerDocument, o),
			...
			cleanData: function (t, e) {
				for (var i, n, s, o, a = 0, r = st.expando, l = st.cache, h = it.deleteExpando, u = st.event.special; null != (i = t[a]); a++)
					if ((e || st.acceptData(i)) && (s = i[r],
						o = s && l[s])) {
						if (o.events)
							for (n in o.events)
								u[n] ? st.event.remove(i, n) : st.removeEvent(i, n, o.handle);
						l[s] && (delete l[s],
							h ? delete i[r] : typeof i.removeAttribute !== wt ? i.removeAttribute(r) : i[r] = null,
							K.push(s))
					}
			}
		}),
		st.fn.extend({
			...
			remove: function (t, e) {
				for (var i, n = t ? st.filter(t, this) : this, s = 0; null != (i = n[s]); s++)
					e || 1 !== i.nodeType || st.cleanData(g(i)),
						i.parentNode && (e && st.contains(i.ownerDocument, i) && x(g(i, "script")),
			...
			html: function (t) {
				return Ft(this, function (t) {
					...
					if (!("string" != typeof t || Bt.test(t) || !it.htmlSerialize && Ot.test(t) || !it.leadingWhitespace && Wt.test(t) || Kt[(Rt.exec(t) || ["", ""])[1].toLowerCase()])) {
						t = t.replace(Lt, "<$1></$2>");
						try {
							for (; n > i; i++)
								e = this[i] || {},
									1 === e.nodeType && (st.cleanData(g(e, !1)),
										e.innerHTML = t);
							e = 0
						} catch (t) { }
					}
			...
			domManip: function (t, e) {
				t = G.apply([], t);
				var i, n, s, o, a, r, l = 0, h = this.length, u = this, c = h - 1, d = t[0], p = st.isFunction(d);
				if (p || h > 1 && "string" == typeof d && !it.checkClone && $t.test(d))
					return this.each(function (i) {
						var n = u.eq(i);
						p && (t[0] = d.call(this, i, n.html())),
							n.domManip(t, e)
					});
				if (h && (r = st.buildFragment(t, this[0].ownerDocument, !1, this),
					i = r.firstChild,
					1 === r.childNodes.length && (r = i),
					i)) {
					for (o = st.map(g(r, "script"), y),
						s = o.length; h > l; l++)
						n = r,
							l !== c && (n = st.clone(n, !0, !0),
					...
					if (s)
						for (a = o[o.length - 1].ownerDocument,
							...
							l = 0; s > l; l++)
							n = o[l],
								Yt.test(n.type || "") && !st._data(n, "globalEval") && st.contains(a, n) && (n.src ? st._evalUrl && st._evalUrl(n.src) : st.globalEval((n.text || n.textContent || n.innerHTML || "").replace(Xt, "")));
					r = i = null
				}
				return this
			}
		...
		st.each({
			...
			st.fn[t] = function (t) {
				for (var i, n = 0, s = [], o = st(t), a = o.length - 1; a >= n; n++)
	...
	!function () {
		...
		it.shrinkWrapBlocks = function () {
			...
			return i = ft.getElementsByTagName("body")[0],
				i && i.style ? (e = ft.createElement("div"),
					n = ft.createElement("div"),
					n.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px",
					i.appendChild(n).appendChild(e),
					typeof e.style.zoom !== wt && (e.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1",
	...
	var Zt, te, ee = /^margin/, ie = new RegExp("^(" + Dt + ")(?!px)[a-z%]+$", "i"), ne = /^(top|right|bottom|left)$/;
	t.getComputedStyle ? (Zt = function (e) {
		...
		te = function (t, e, i) {
			...
			return i = i || Zt(t),
				...
				i && ("" !== a || st.contains(t.ownerDocument, t) || (a = st.style(t, e)),
					ie.test(a) && ee.test(e) && (n = r.width,
						s = r.minWidth,
						o = r.maxWidth,
		...
		!function () {
			function e() {
				...
				(i = ft.getElementsByTagName("body")[0]) && i.style && (e = ft.createElement("div"),
					...
					t.getComputedStyle && (o = "1%" !== (t.getComputedStyle(e, null) || {}).top,
						...
						s.style.cssText = e.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0",
						s.style.marginRight = s.style.width = "0",
						e.style.width = "1px",
						l = !parseFloat((t.getComputedStyle(s, null) || {}).marginRight),
						e.removeChild(s)),
			...
			i = ft.createElement("div"),
				...
				(n = s && s.style) && (n.cssText = "float:left;opacity:.5",
	...
	st.extend({
		...
		style: function (t, e, i, n) {
			if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
				var s, o, a, r = st.camelCase(e), l = t.style;
				if (e = st.cssProps[r] || (st.cssProps[r] = S(l, r)),
					a = st.cssHooks[e] || st.cssHooks[r],
					void 0 === i)
					return a && "get" in a && void 0 !== (s = a.get(t, !1, n)) ? s : l[e];
				if (o = typeof i,
					"string" === o && (s = le.exec(i)) && (i = (s[1] + 1) * s[2] + parseFloat(st.css(t, e)),
						o = "number"),
					null != i && i === i && ("number" !== o || st.cssNumber[r] || (i += "px"),
						it.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (l[e] = "inherit"),
		...
		st.each(["height", "width"], function (t, e) {
			st.cssHooks[e] = {
				...
				set: function (t, i, n) {
					var s = n && Zt(t);
					return N(t, i, n ? E(t, e, n, it.boxSizing && "border-box" === st.css(t, "boxSizing", !1, s), s) : 0)
				}
			}
		}),
		it.opacity || (st.cssHooks.opacity = {
			...
			set: function (t, e) {
				...
				i.zoom = 1,
					(e >= 1 || "" === e) && "" === st.trim(o.replace(se, "")) && i.removeAttribute && (i.removeAttribute("filter"),
		...
		st.each({
			...
			st.cssHooks[t + e] = {
				...
				ee.test(t) || (st.cssHooks[t + e].set = N)
		}),
		st.fn.extend({
			css: function (t, e) {
		...
		st.fx.step = {};
	var de, pe, fe = /^(?:toggle|show|hide)$/, me = new RegExp("^(?:([+-])=|)(" + Dt + ")([a-z%]*)$", "i"), ge = /queueHooks$/, ve = [z], be = {
		"*": [function (t, e) {
	...
	st.Animation = st.extend(W, {
		...
		st.fn.extend({
			...
			finish: function (t) {
				return !1 !== t && (t = t || "fx"),
					this.each(function () {
						var e, i = st._data(this), n = i[t + "queue"], s = i[t + "queueHooks"], o = st.timers, a = n ? n.length : 0;
						for (i.finish = !0,
							st.queue(this, t, []),
	...
	st.fn.extend({
		val: function (t) {
			var e, i, n, s = this[0];
			return arguments.length ? (n = st.isFunction(t),
				this.each(function (i) {
					var s;
					1 === this.nodeType && (s = n ? t.call(this, i, st(this).val()) : t,
						null == s ? s = "" : "number" == typeof s ? s += "" : st.isArray(s) && (s = st.map(s, function (t) {
							return null == t ? "" : t + ""
						})),
						(e = st.valHooks[this.type] || st.valHooks[this.nodeName.toLowerCase()]) && "set" in e && void 0 !== e.set(this, s, "value") || (this.value = s))
				})) : s ? (e = st.valHooks[s.type] || st.valHooks[s.nodeName.toLowerCase()],
				...
				select: {
					get: function (t) {
						for (var e, i, n = t.options, s = t.selectedIndex, o = "select-one" === t.type || 0 > s, a = o ? null : [], r = o ? s + 1 : n.length, l = 0 > s ? r : o ? s : 0; r > l; l++)
							if (i = n[l],
								!(!i.selected && l !== s || (it.optDisabled ? i.disabled : null !== i.getAttribute("disabled")) || i.parentNode.disabled && st.nodeName(i.parentNode, "optgroup"))) {
								if (e = st(i).val(),
									o)
									return e;
								a.push(e)
	...
	var _e, xe, we = st.expr.attrHandle, Ce = /^(?:checked|selected)$/i, ke = it.getSetAttribute, De = it.input;
	st.fn.extend({
		attr: function (t, e) {
			return Ft(this, st.attr, t, e, arguments.length > 1)
		},
		...
		st.extend({
			attr: function (t, e, i) {
				...
				if (t && 3 !== o && 8 !== o && 2 !== o)
					return typeof t.getAttribute === wt ? st.prop(t, e, i) : (1 === o && st.isXMLDoc(t) || (e = e.toLowerCase(),
						n = st.attrHooks[e] || (st.expr.match.bool.test(e) ? xe : _e)),
						void 0 === i ? n && "get" in n && null !== (s = n.get(t, e)) ? s : (s = st.find.attr(t, e),
							null == s ? void 0 : s) : null !== i ? n && "set" in n && void 0 !== (s = n.set(t, i, e)) ? s : (t.setAttribute(e, i + ""),
								i) : void st.removeAttr(t, e))
			},
			removeAttr: function (t, e) {
				...
				if (o && 1 === t.nodeType)
					for (; i = o[s++];)
						n = st.propFix[i] || i,
							st.expr.match.bool.test(i) ? De && ke || !Ce.test(i) ? t[n] = !1 : t[st.camelCase("default-" + i)] = t[n] = !1 : st.attr(t, i, ""),
		...
		xe = {
			set: function (t, e, i) {
				return !1 === e ? st.removeAttr(t, i) : De && ke || !Ce.test(i) ? t.setAttribute(!ke && st.propFix[i] || i, i) : t[st.camelCase("default-" + i)] = t[i] = !0,
					i
			}
		},
		st.each(st.expr.match.bool.source.match(/\w+/g), function (t, e) {
			var i = we[e] || st.find.attr;
		...
		De && ke || (st.attrHooks.value = {
			set: function (t, e, i) {
				return st.nodeName(t, "input") ? void (t.defaultValue = e) : _e && _e.set(t, e, i)
			}
		}),
		ke || (_e = {
			set: function (t, e, i) {
	...
	st.fn.extend({
		prop: function (t, e) {
			return Ft(this, st.prop, t, e, arguments.length > 1)
		},
		...
		addClass: function (t) {
			...
			if (h)
				for (e = (t || "").match(bt) || []; l > r; r++)
					if (i = this[r],
						n = 1 === i.nodeType && (i.className ? (" " + i.className + " ").replace(Fe, " ") : " ")) {
						for (o = 0; s = e[o++];)
							n.indexOf(" " + s + " ") < 0 && (n += s + " ");
						a = st.trim(n),
		...
		toggleClass: function (t, e) {
			...
			return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : this.each(st.isFunction(t) ? function (i) {
				...
				: function () {
                    ...
                    (i === wt || "boolean" === i) && (this.className && st._data(this, "__className__", this.className),
							this.className = this.className || !1 === t ? "" : st._data(this, "__className__") || "")
				}
			)
		},
		hasClass: function (t) {
			for (var e = " " + t + " ", i = 0, n = this.length; n > i; i++)
				if (1 === this[i].nodeType && (" " + this[i].className + " ").replace(Fe, " ").indexOf(e) >= 0)
					return !0;
			return !1
		}
	}),
	...
	st.parseJSON = function (e) {
		...
		;
	var Ae, Me, Pe = /#.*$/, He = /([?&])_=[^&]*/, ze = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Oe = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, We = /^(?:GET|HEAD)$/, Le = /^\/\//, Re = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, je = {}, qe = {}, Be = "*/".concat("*");
	try {
		Me = location.href
	} catch (t) {
		Me = ft.createElement("a"),
			Me.href = "",
			Me = Me.href
	}
	Ae = Re.exec(Me.toLowerCase()) || [],
		st.extend({
			active: 0,
			lastModified: {},
			etag: {},
			...
			ajax: function (t, e) {
				function i(t, e, i, n) {
					...
					2 !== y && (y = 2,
						...
						i && (b = q(c, x, i)),
						b = B(c, b, x, s),
						s ? (c.ifModified && (_ = x.getResponseHeader("Last-Modified"),
							_ && (st.lastModified[o] = _),
							(_ = x.getResponseHeader("etag")) && (st.etag[o] = _)),
							204 === t || "HEAD" === c.type ? w = "nocontent" : 304 === t ? w = "notmodified" : (w = b.state,
								u = b.data,
								v = b.error,
								s = !v)) : (v = w,
									(t || !w) && (w = "error",
						...
						x.status = t,
						x.statusText = (e || w) + "",
						s ? f.resolveWith(d, [u, w, x]) : f.rejectWith(d, [x, w, v]),
						x.statusCode(g),
						g = void 0,
						l && p.trigger(s ? "ajaxSuccess" : "ajaxError", [x, c, s ? u : v]),
						m.fireWith(d, [x, w]),
						l && (p.trigger("ajaxComplete", [x, c]),
							--st.active || st.event.trigger("ajaxStop")))
				}
				"object" == typeof t && (e = t,
					t = void 0),
					e = e || {};
				var n, s, o, a, r, l, h, u, c = st.ajaxSetup({}, e), d = c.context || c, p = c.context && (d.nodeType || d.jquery) ? st(d) : st.event, f = st.Deferred(), m = st.Callbacks("once memory"), g = c.statusCode || {}, v = {}, b = {}, y = 0, _ = "canceled", x = {
					readyState: 0,
				...
				if (f.promise(x).complete = m.add,
					x.success = x.done,
					x.error = x.fail,
					c.url = ((t || c.url || Me) + "").replace(Pe, "").replace(Le, Ae[1] + "//"),
					c.type = e.method || e.type || c.method || c.type,
					c.dataTypes = st.trim(c.dataType || "*").toLowerCase().match(bt) || [""],
					null == c.crossDomain && (n = Re.exec(c.url.toLowerCase()),
						c.crossDomain = !(!n || n[1] === Ae[1] && n[2] === Ae[2] && (n[3] || ("http:" === n[1] ? "80" : "443")) === (Ae[3] || ("http:" === Ae[1] ? "80" : "443")))),
					c.data && c.processData && "string" != typeof c.data && (c.data = st.param(c.data, c.traditional)),
					R(je, c, e, x),
					2 === y)
					return x;
				l = st.event && c.global,
					...
					c.hasContent = !We.test(c.type),
					o = c.url,
					c.hasContent || (c.data && (o = c.url += (Ee.test(o) ? "&" : "?") + c.data,
						delete c.data),
						!1 === c.cache && (c.url = He.test(o) ? o.replace(He, "$1_=" + Ne++) : o + (Ee.test(o) ? "&" : "?") + "_=" + Ne++)),
					c.ifModified && (st.lastModified[o] && x.setRequestHeader("If-Modified-Since", st.lastModified[o]),
						st.etag[o] && x.setRequestHeader("If-None-Match", st.etag[o])),
					(c.data && c.hasContent && !1 !== c.contentType || e.contentType) && x.setRequestHeader("Content-Type", c.contentType),
					x.setRequestHeader("Accept", c.dataTypes[0] && c.accepts[c.dataTypes[0]] ? c.accepts[c.dataTypes[0]] + ("*" !== c.dataTypes[0] ? ", " + Be + "; q=0.01" : "") : c.accepts["*"]);
				for (s in c.headers)
					x.setRequestHeader(s, c.headers[s]);
				if (c.beforeSend && (!1 === c.beforeSend.call(d, x, c) || 2 === y))
					return x.abort();
				_ = "abort";
				for (s in {
					success: 1,
		...
		st.fn.extend({
			...
			serializeArray: function () {
				return this.map(function () {
					...
					var t = this.type;
					return this.name && !st(this).is(":disabled") && Ke.test(this.nodeName) && !Xe.test(t) && (this.checked || !Nt.test(t))
				}).map(function (t, e) {
					var i = st(this).val();
	...
	st.ajaxSetup({
		...
		st.ajaxPrefilter("json jsonp", function (e, i, n) {
			...
			return r || "jsonp" === e.dataTypes[0] ? (s = e.jsonpCallback = st.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
				r ? e[r] = e[r].replace(Ze, "$1" + s) : !1 !== e.jsonp && (e.url += (Ee.test(e.url) ? "&" : "?") + e.jsonp + "=" + s),
		...
		st.parseHTML = function (t, e, i) {
			...
			var n = ct.exec(t)
				, s = !i && [];
			return n ? [e.createElement(n[1])] : (n = st.buildFragment([t], e, s),
	...
	st.fn.load = function (t, e, i) {
		...
		return r >= 0 && (n = st.trim(t.slice(r, t.length)),
			t = t.slice(0, r)),
			st.isFunction(e) ? (i = e,
	...
	st.offset = {
		setOffset: function (t, e, i) {
			var n, s, o, a, r, l, h, u = st.css(t, "position"), c = st(t), d = {};
		...
		st.fn.extend({
			offset: function (t) {
				...
				return o ? (e = o.documentElement,
					st.contains(e, s) ? (typeof s.getBoundingClientRect !== wt && (n = s.getBoundingClientRect()),
						i = X(o),
						{
			...
			offsetParent: function () {
				return this.map(function () {
					for (var t = this.offsetParent || ei; t && !st.nodeName(t, "html") && "static" === st.css(t, "position");)
						t = t.offsetParent;
					return t || ei
				})
			}
		...
		st.each(["top", "left"], function (t, e) {
			st.cssHooks[e] = T(it.pixelPosition, function (t, i) {
				return i ? (i = te(t, e),
					ie.test(i) ? st(t).position()[e] + "px" : i) : void 0
			})
		}),
		st.each({
			Height: "height",
				...
				st.fn[n] = function (n, s) {
					...
					return Ft(this, function (e, i, n) {
						...
						return st.isWindow(e) ? e.document.documentElement["client" + t] : 9 === e.nodeType ? (s = e.documentElement,
							Math.max(e.body["scroll" + t], s["scroll" + t], e.body["offset" + t], s["offset" + t], s["client" + t])) : void 0 === n ? st.css(e, i, a) : st.style(e, i, n, a)
					}, e, o ? n : void 0, o, null)
				}
			})
		}),
			...
			t.extend(t.validator, {
				...
				attributeRules: function (e) {
					...
					for (var o in t.validator.methods) {
						var a;
						"required" === o ? (a = n.get(0).getAttribute(o),
							"" === a && (a = !0),
							a = !!a) : a = n.attr(o),
							/min|max/.test(o) && (null === s || /number|range|text/.test(s)) && (a = Number(a)),
	...
	function (t) {
		...
		function e(e, n) {
			...
			return "area" === r ? (s = e.parentNode,
				o = s.name,
				!(!e.href || !o || "map" !== s.nodeName.toLowerCase()) && (!!(a = t("img[usemap='#" + o + "']")[0]) && i(a))) : (/input|select|textarea|button|object/.test(r) ? !e.disabled : "a" === r ? e.href || n : n) && i(e)
		}
		function i(e) {
		...
		t.cleanData = function (e) {
			...
			t.widget.extend = function (e) {
				for (var i, n, s = u.call(arguments, 1), o = 0, a = s.length; o < a; o++)
					for (i in s[o])
						n = s[o][i],
					...
					return s = !o && a.length ? t.widget.extend.apply(null, [s].concat(a)) : s,
						o ? this.each(function () {
							...
							return "instance" === s ? (r = o,
								!1) : o ? t.isFunction(o[s]) && "_" !== s.charAt(0) ? (i = o[s].apply(o, a),
		...
		!function () {
			...
			t.ui = t.ui || {};
			var s, o, a = Math.max, r = Math.abs, l = Math.round, h = /left|center|right/, u = /top|center|bottom/, c = /[\+\-]\d+(\.[\d]+)?%?/, d = /^\w+/, p = /%$/, f = t.fn.position;
			t.position = {
				...
				t.fn.position = function (s) {
					...
					s = t.extend({}, s);
					var p, m, g, v, b, y, _ = t(s.of), x = t.position.getWithinInfo(s.within), w = t.position.getScrollInfo(x), C = (s.collision || "flip").split(" "), k = {};
					return y = n(_),
						...
						b.top += p[1],
						this.each(function () {
							var n, h, u = t(this), c = u.outerWidth(), d = u.outerHeight(), f = i(this, "marginLeft"), y = i(this, "marginTop"), D = c + f + i(this, "marginRight") + w.width, T = d + y + i(this, "marginBottom") + w.height, S = t.extend({}, b), F = e(k.my, u.outerWidth(), u.outerHeight());
							"right" === s.my[0] ? S.left -= c : "center" === s.my[0] && (S.left -= c / 2),
								...
								s.using && (h = function (t) {
									...
									m < c && r(e + i) < m && (l.horizontal = "center"),
										g < d && r(n + o) < g && (l.vertical = "middle"),
				...
				t.ui.position = {
					fit: {
						left: function (t, e) {
							...
							e.collisionWidth > o ? l > 0 && h <= 0 ? (i = t.left + l + e.collisionWidth - o - s,
								t.left += l - i) : t.left = h > 0 && l <= 0 ? s : l > h ? s + o - e.collisionWidth : s : l > 0 ? t.left += l : h > 0 ? t.left -= h : t.left = a(t.left - r, t.left)
						},
						top: function (t, e) {
							...
							e.collisionHeight > o ? l > 0 && h <= 0 ? (i = t.top + l + e.collisionHeight - o - s,
								t.top += l - i) : t.top = h > 0 && l <= 0 ? s : l > h ? s + o - e.collisionHeight : s : l > 0 ? t.top += l : h > 0 ? t.top -= h : t.top = a(t.top - r, t.top)
						}
					},
					flip: {
						left: function (t, e) {
						...
						top: function (t, e) {
							...
							u < 0 ? (n = t.top + p + f + m + e.collisionHeight - a - o,
								t.top + p + f + m > u && (n < 0 || n < r(u)) && (t.top += p + f + m)) : c > 0 && (i = t.top - e.collisionPosition.marginTop + p + f + m - l,
									t.top + p + f + m > c && (i > 0 || r(i) < c) && (t.top += p + f + m))
						}
					},
					flipfit: {
						left: function () {
		...
		t.ui.position,
			t.widget("ui.accordion", {
				...
				_eventHandler: function (e) {
					...
					e.preventDefault(),
						o && !i.collapsible || !1 === this._trigger("beforeActivate", e, h) || (i.active = !a && this.headers.index(s),
							this.active = o ? t() : s,
							this._toggle(h),
				...
				_animate: function (t, e, i) {
					var n, s, o, a = this, r = 0, l = t.length && (!e.length || t.index() < e.index()), h = this.options.animate || {}, u = l && h.down || h, c = function () {
						a._toggleComplete(i)
					};
					return "number" == typeof u && (o = u),
						...
						e.length ? t.length ? (n = t.show().outerHeight(),
							...
							})) : e.animate(this.hideProps, o, s, c) : t.animate(this.showProps, o, s, c)
				},
		...
		t.extend(s.prototype, {
					...
					i = t.datepicker._getInst(e),
						...
						!1 !== o && (r(i.settings, o),
							...
							i.inline || (h = t.datepicker._get(i, "showAnim"),
								...
								t.effects && t.effects.effect[h] ? i.dpDiv.show(h, t.datepicker._get(i, "showOptions"), u) : i.dpDiv[h || "show"](h ? u : null),
			...
			_generateHTML: function (t) {
				...
				for (t.drawMonth = Z,
					...
					n = this._canAdjustMonth(t, -1, tt, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "e" : "w") + "'>" + i + "</span></a>" : $ ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "e" : "w") + "'>" + i + "</span></a>",
					s = this._get(t, "nextText"),
					s = Y ? this.formatDate(s, this._daylightSavingAdjust(new Date(tt, Z + K, 1)), this._getFormatConfig(t)) : s,
					o = this._canAdjustMonth(t, 1, tt, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "w" : "e") + "'>" + s + "</span></a>" : $ ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "w" : "e") + "'>" + s + "</span></a>",
					...
					h = B ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (q ? l : "") + (this._isInRange(t, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + a + "</button>" : "") + (q ? "" : l) + "</div>" : "",
					...
					for (C = "",
						...
						for (S += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + T + "'>" + (/all|left/.test(T) && 0 === w ? q ? o : n : "") + (/all|right/.test(T) && 0 === w ? q ? n : o : "") + this._generateMonthYearHeader(t, Z, tt, Q, J, w > 0 || k > 0, f, m) + "</div><table class='ui-datepicker-calendar'><thead><tr>",
							F = c ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "",
							x = 0; x < 7; x++)
							N = (x + u) % 7,
								F += "<th scope='col'" + ((x + u + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[N] + "'>" + p[N] + "</span></th>";
						for (S += F + "</tr></thead><tbody>",
							E = this._getDaysInMonth(tt, Z),
							tt === t.selectedYear && Z === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, E)),
							I = (this._getFirstDayOfMonth(tt, Z) - u + 7) % 7,
							A = Math.ceil((I + E) / 7),
							M = V && this.maxRows > A ? this.maxRows : A,
							this.maxRows = M,
							P = this._daylightSavingAdjust(new Date(tt, Z, 1 - I)),
							H = 0; H < M; H++) {
							for (S += "<tr>",
								z = c ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(P) + "</td>" : "",
								x = 0; x < 7; x++)
								O = g ? g.apply(t.input ? t.input[0] : null, [P]) : [!0, ""],
									W = P.getMonth() !== Z,
									L = W && !b || !O[0] || Q && P < Q || J && P > J,
									z += "<td class='" + ((x + u + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (W ? " ui-datepicker-other-month" : "") + (P.getTime() === D.getTime() && Z === t.selectedMonth && t._keyEvent || y.getTime() === P.getTime() && y.getTime() === D.getTime() ? " " + this._dayOverClass : "") + (L ? " " + this._unselectableClass + " ui-state-disabled" : "") + (W && !v ? "" : " " + O[1] + (P.getTime() === G.getTime() ? " " + this._currentClass : "") + (P.getTime() === j.getTime() ? " ui-datepicker-today" : "")) + "'" + (W && !v || !O[2] ? "" : " title='" + O[2].replace(/'/g, "&#39;") + "'") + (L ? "" : " data-handler='selectDay' data-event='click' data-month='" + P.getMonth() + "' data-year='" + P.getFullYear() + "'") + ">" + (W && !v ? "&#xa0;" : L ? "<span class='ui-state-default'>" + P.getDate() + "</span>" : "<a class='ui-state-default" + (P.getTime() === j.getTime() ? " ui-state-highlight" : "") + (P.getTime() === G.getTime() ? " ui-state-active" : "") + (W ? " ui-priority-secondary" : "") + "' href='#'>" + P.getDate() + "</a>") + "</td>",
						...
						Z++ ,
							Z > 11 && (Z = 0,
								tt++),
							S += "</tbody></table>" + (V ? "</div>" + (U[0] > 0 && k === U[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : ""),
							C += S
					}
					_ += C
				}
			...
			_generateMonthYearHeader: function (t, e, i, n, s, o, a, r) {
				...
				if (o || !g)
					...
					for (l = n && n.getFullYear() === i,
						...
						u = 0; u < 12; u++)
						(!l || u >= n.getMonth()) && (!h || u <= s.getMonth()) && (_ += "<option value='" + u + "'" + (u === e ? " selected='selected'" : "") + ">" + r[u] + "</option>");
					_ += "</select>"
				}
				if (b || (y += _ + (!o && g && v ? "" : "&#xa0;")),
					!t.yearshtml)
		...
		t.widget("ui.draggable", t.ui.mouse, {
			...
			_mouseCapture: function (e) {
				...
				return !(this.helper || n.disabled || t(e.target).closest(".ui-resizable-handle").length > 0) && (this.handle = this._getHandle(e),
					!!this.handle && (t(!0 === n.iframeFix ? "iframe" : n.iframeFix).each(function () {
				...
				drag: function (e, i, n) {
					...
					for (d = n.snapElements.length - 1; d >= 0; d--)
						l = n.snapElements[d].left,
							...
							u = n.snapElements[d].top,
							c = u + n.snapElements[d].height,
							v < l - m || g > h + m || y < u - m || b > c + m || !t.contains(n.snapElements[d].item.ownerDocument, n.snapElements[d].item) ? (n.snapElements[d].snapping && n.options.snap.release && n.options.snap.release.call(n.element, e, t.extend(n._uiHash(), {
								...
								n.snapElements[d].snapping = !1) : ("inner" !== f.snapMode && (s = Math.abs(u - y) <= m,
									...
									p = s || o || a || r,
									"outer" !== f.snapMode && (s = Math.abs(u - b) <= m,
										o = Math.abs(c - y) <= m,
										a = Math.abs(l - g) <= m,
										r = Math.abs(h - v) <= m,
										s && (i.position.top = n._convertPositionTo("relative", {
						...
						/^(se|s|e)$/.test(r) ? (i.size.width = p,
							i.size.height = f) : /^(ne)$/.test(r) ? (i.size.width = p,
								...
								i.position.top = a.top - d) : /^(sw)$/.test(r) ? (i.size.width = p,
									i.size.height = f,
									i.position.left = a.left - c) : ((f - u <= 0 || p - h <= 0) && (e = i._getPaddingPlusBorderDimensions(this)),
										f - u > 0 ? (i.size.height = f,
											i.position.top = a.top - d) : (f = u - e.height,
												i.size.height = f,
												i.position.top = a.top + o.height - f),
										p - h > 0 ? (i.size.width = p,
											i.position.left = a.left - c) : (p = u - e.height,
												i.size.width = p,
					...
					l.fn = t.extend(l.prototype, {
						parse: function (e, s, a, r) {
							...
							var u = this
								, c = t.type(e)
								, d = this._rgba = [];
							return void 0 !== s && (e = [e, s, a, r],
								c = "array"),
								"string" === c ? this.parse(n(e) || o._default) : "array" === c ? (p(h.rgba.props, function (t, n) {
									d[n.idx] = i(e[n.idx], n)
								}),
		...
		t.effects,
			t.effects.effect.blind = function (e, i) {
				var n, s, o, a = t(this), r = /up|down|vertical/, l = /up|left|vertical|horizontal/, h = ["position", "top", "bottom", "left", "right", "height", "width"], u = t.effects.setMode(a, e.mode || "hide"), c = e.direction || "up", d = r.test(c), p = d ? "height" : "width", f = d ? "top" : "left", m = l.test(c), g = {}, v = "show" === u;
			...
			t.effects.effect.bounce = function (e, i) {
				var n, s, o, a = t(this), r = ["position", "top", "bottom", "left", "right", "height", "width"], l = t.effects.setMode(a, e.mode || "effect"), h = "hide" === l, u = "show" === l, c = e.direction || "up", d = e.distance, p = e.times || 5, f = 2 * p + (u || h ? 1 : 0), m = e.duration / f, g = e.easing, v = "up" === c || "down" === c ? "top" : "left", b = "up" === c || "left" === c, y = a.queue(), _ = y.length;
			...
			t.effects.effect.clip = function (e, i) {
				var n, s, o, a = t(this), r = ["position", "top", "bottom", "left", "right", "height", "width"], l = t.effects.setMode(a, e.mode || "hide"), h = "show" === l, u = e.direction || "vertical", c = "vertical" === u, d = c ? "height" : "width", p = c ? "top" : "left", f = {};
				t.effects.save(a, r),
					a.show(),
					n = t.effects.createWrapper(a).css({
						overflow: "hidden"
			...
			t.effects.effect.drop = function (e, i) {
				var n, s = t(this), o = ["position", "top", "bottom", "left", "right", "opacity", "height", "width"], a = t.effects.setMode(s, e.mode || "hide"), r = "show" === a, l = e.direction || "left", h = "up" === l || "down" === l ? "top" : "left", u = "up" === l || "left" === l ? "pos" : "neg", c = {
					opacity: r ? 1 : 0
				};
				t.effects.save(s, o),
					s.show(),
			...
			t.effects.effect.explode = function (e, i) {
				...
				var o, a, r, l, h, u, c = e.pieces ? Math.round(Math.sqrt(e.pieces)) : 3, d = c, p = t(this), f = t.effects.setMode(p, e.mode || "hide"), m = "show" === f, g = p.show().css("visibility", "hidden").offset(), v = Math.ceil(p.outerWidth() / d), b = Math.ceil(p.outerHeight() / c), y = [];
				for (o = 0; o < c; o++)
					for (l = g.top + o * b,
						u = o - (c - 1) / 2,
						a = 0; a < d; a++)
			...
			t.effects.effect.fold = function (e, i) {
				var n, s, o = t(this), a = ["position", "top", "bottom", "left", "right", "height", "width"], r = t.effects.setMode(o, e.mode || "hide"), l = "show" === r, h = "hide" === r, u = e.size || 15, c = /([0-9]+)%/.exec(u), d = !!e.horizFirst, p = l !== d, f = p ? ["width", "height"] : ["height", "width"], m = e.duration / 2, g = {}, v = {};
				t.effects.save(o, a),
					o.show(),
			...
			t.effects.effect.size = function (e, i) {
				var n, s, o, a = t(this), r = ["position", "top", "bottom", "left", "right", "width", "height", "overflow", "opacity"], l = ["position", "top", "bottom", "left", "right", "overflow", "opacity"], h = ["width", "height", "overflow"], u = ["fontSize"], c = ["borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"], d = ["borderLeftWidth", "borderRightWidth", "paddingLeft", "paddingRight"], p = t.effects.setMode(a, e.mode || "effect"), f = e.restore || "effect" !== p, m = e.scale || "both", g = e.origin || ["middle", "center"], v = a.css("position"), b = f ? r : l, y = {
					height: 0,
					width: 0,
					outerHeight: 0,
					outerWidth: 0
				...
				"show" === p && a.show(),
					...
					"box" !== m && "both" !== m || (o.from.y !== o.to.y && (b = b.concat(c),
					...
					"content" !== m && "both" !== m || o.from.y !== o.to.y && (b = b.concat(u).concat(h),
			...
			t.effects.effect.pulsate = function (e, i) {
				var n, s = t(this), o = t.effects.setMode(s, e.mode || "show"), a = "show" === o, r = "hide" === o, l = a || "hide" === o, h = 2 * (e.times || 5) + (l ? 1 : 0), u = e.duration / h, c = 0, d = s.queue(), p = d.length;
			...
			t.effects.effect.shake = function (e, i) {
				var n, s = t(this), o = ["position", "top", "bottom", "left", "right", "height", "width"], a = t.effects.setMode(s, e.mode || "effect"), r = e.direction || "left", l = e.distance || 20, h = e.times || 3, u = 2 * h + 1, c = Math.round(e.duration / u), d = "up" === r || "down" === r ? "top" : "left", p = "up" === r || "left" === r, f = {}, m = {}, g = {}, v = s.queue(), b = v.length;
			...
			t.effects.effect.slide = function (e, i) {
				var n, s = t(this), o = ["position", "top", "bottom", "left", "right", "width", "height"], a = t.effects.setMode(s, e.mode || "show"), r = "show" === a, l = e.direction || "left", h = "up" === l || "down" === l ? "top" : "left", u = "up" === l || "left" === l, c = {};
				t.effects.save(s, o),
					s.show(),
						...
						return o > r && (i = r,
							...
							this.selectees.each(function () {
								var i = t.data(this, "selectable-item")
									, h = !1;
								i && i.element !== n.element[0] && ("touch" === s.tolerance ? h = !(i.left > r || i.right < o || i.top > l || i.bottom < a) : "fit" === s.tolerance && (h = i.left > o && i.right < r && i.top > a && i.bottom < l),
			...
			t.widget("ui.slider", t.ui.mouse, {
				...
				_slide: function (t, e, i) {
					...
					this.options.values && this.options.values.length ? (n = this.values(e ? 0 : 1),
						...
						i !== this.values(e) && (s = this.values(),
							...
							n = this.values(e ? 0 : 1),
							!1 !== o && this.values(e, i))) : i !== this.value() && !1 !== (o = this._trigger("slide", t, {
								handle: this.handles[e],
								value: i
							})) && this.value(i)
				},
				...
				_handleEvents: {
					keydown: function (e) {
						...
						i = n = this.options.values && this.options.values.length ? this.values(o) : this.value(),
						e.keyCode) {
							case t.ui.keyCode.HOME:
								n = this._valueMin();
								break;
			...
			t.widget("ui.sortable", t.ui.mouse, {
				...
				_intersectsWith: function (t) {
					var e = this.positionAbs.left
						...
						, c = "x" === this.options.axis || n + h > r && n + h < l
			...
			t.widget("ui.tabs", {
				...
				_eventHandler: function (e) {
					...
					e.preventDefault(),
						o.hasClass("ui-state-disabled") || o.hasClass("ui-tabs-loading") || this.running || a && !i.collapsible || !1 === this._trigger("beforeActivate", e, u) || (i.active = !r && this.tabs.index(o),
							this.active = a ? t() : o,
	...
	function estanTodosLosDatos() {
		var ret = isDataCorrect($('#userName')) && isDataCorrect($('#userEmail')) && isDataCorrect($('#userMessage')) && isDataCorrect($('#tel'));
		return ret;
		}
			...
			build: function (t) {
				$(".home-slider-1 .tp-banner").each(function () {
					var e = $(this)
						...
						, n = $.extend({}, i, t, e.data("plugin-options"));
					e.revolution(n).addClass("slider-init")
				})
			},
			menu: function () {
				$("#myTopnav li a, #jx-main-menu li a,.icons-section a").click(function (t) {
					var e = $(this).attr("href");
					if (-1 === e.indexOf("http") && -1 !== e.indexOf("#")) {
						t.preventDefault();
...
var savings_Serv = function () {
	function t(t) {
		return parseInt(t.toFixed(2))
	}
	function e() {
		return s() * y.anosSeleccionados + o()
	}
	function i() {
		return r() - c()
	}
	...
	function o() {
		return a() * y.anosSeleccionados - f() * y.anosSeleccionados
	}
	function a() {
		return y.servAnuales * y.costoPromedioService
	}
	function r() {
		return y.costoCombustible * y.kmRecorridoXdia / y.rendimientoNaftaXlt
	}
	function l() {
		return y.kmRecorridoXdia / b.rendXCarga
	}
	function h() {
		return y.kmRecorridoXdia * y.diasAno
	}
	function u() {
		return b.precioKw * b.kwXhrXcarga
	}
	function c() {
		return u() * l()
	}
	function d() {
		return y.kmRecorridoXdia * y.diasAno / b.serviceAnualesDur
	}
	function p() {
		return h() / b.recambioBatDur
	}
	function f() {
		return d() * b.costoServicio + p() * b.recambioBatPrecio
	}
	function m() {
		return y.kmRecorridoXdia * y.diasAno
	}
	...
	function v() {
		return $.get("https://www.google.com/finance/converter?a=1&from=USD&to=UYU", function (t) {
			var e = t.indexOf("<span class=bld>")
				, i = t.indexOf("UYU</span>");
			y.usdBill = parseFloat(t.substring(e + "<span class=bld>".length, i))
		})
	}
	var b = {
		rendXCarga: 100,
		cantCargasDiarias: .41,
		kwXhrXcarga: 10.8,
		precioKw: 4.5,
		serviceAnualesDur: 5e3,
		costoServicio: 1800,
		recambioBatDur: 15e3,
	...
	return {
		auto: b,
		datos: y,
		cantidadDeCargasDiarias: l,
		costoDeCarga: u,
		costosDiarios: c,
		serviceAnuales: d,
		costoTotalServicio: f,
		costoNaftaAnualService: a,
		costoDiarioNafta: r,
		ahorroService: o,
		ahorroMensual: n,
		ahorroAnual: s,
		ahorroTotalServyNaft: e,
		cantBatACambiar: p,
		kmAnuales: m,
		toFixed0Nr: t,
		getValorUsd: v,
...
!function (t) {
	function e() {
		$("#rendXCarga").val(t.auto.rendXCarga),
			$("#precioKw").val(t.auto.precioKw),
			$("#costoServicio").val(t.auto.costoServicio),
			$("#recambioBatPrecio").val(t.auto.recambioBatPrecio)
	}
	function i() {
		$("#kmsxdia").text(t.datos.kmRecorridoXdia),
			$("#costoCombustible").val(t.datos.costoCombustible),
			$("#rendimientoNaftaXlt").val(t.datos.rendimientoNaftaXlt),
			$("#servAnuales").val(t.datos.servAnuales),
			$("#tiempoUsoNr").text(t.datos.anosSeleccionados),
			$("#tiempoUsoNr2").text(t.datos.anosSeleccionados),
			$("#costoPromedioService").val(t.datos.costoPromedioService)
	}
	function n() {
		$("#costoDeCarga").val(t.toFixed0Nr(t.costoDeCarga())),
			$("#serviceAnuales").val(t.toFixed0Nr(t.serviceAnuales())),
			$("#cantBatACambiar").val(t.toFixed0Nr(t.cantBatACambiar())),
			$("#costoTotalServicio").val(t.toFixed0Nr(t.costoTotalServicio())),
			$("#ahorroMensual").val(t.toFixed0Nr(t.ahorroMensual())),
			$("#ahorroAnual").val(t.toFixed0Nr(t.ahorroAnual())),
			$("#ahorroTotalServyNaft").val(t.toFixed0Nr(t.ahorroTotalServyNaft())),
			$("#ahorroService").val(t.toFixed0Nr(t.ahorroService())),
			$("#kmAnualesnf").text(t.toFixed0Nr(t.kmAnuales())),
			$("#kmAnualesem").text(t.toFixed0Nr(t.kmAnuales())),
			$("#ahorroTotalServyNaftUsd").val(t.toFixed0Nr(t.ahorroTotalUsd()))
	}
	$("#kmsNafta").slider({
		min: 1,
		max: 500,
		range: "min",
		value: t.datos.kmRecorridoXdia,
		slide: function (e, i) {
			t.datos.kmRecorridoXdia = i.value - 1,
				$("#kmsxdia").text(t.datos.kmRecorridoXdia),
				n()
		}
	}),
		$("#tiempoUso").slider({
			...
			max: 100,
			range: "min",
			value: t.datos.anosSeleccionados,
			slide: function (e, i) {
				t.datos.anosSeleccionados = i.value - 1,
					$("#tiempoUsoNr").text(t.datos.anosSeleccionados),
					$("#tiempoUsoNr2").text(t.datos.anosSeleccionados),
					n()
			}
		...
		$("#costoCombustible,#rendimientoNaftaXlt,#servAnuales,#costoPromedioService").on("change", function () {
			t.datos[this.id] = this.value,
				n()
		}),
		function () {
			t.getValorUsd().then(function () {
				$("#ahorroTotalServyNaftUsd").val(t.toFixed0Nr(t.ahorroTotalUsd()))
			}),
				e(),
				i(),
	...
	function () {
		function t() {
			$(window).scrollTop() > 500 ? $(".navbar-fixed-top").addClass("nav-up") : $(".navbar-fixed-top").removeClass("nav-up")
		}
		!function () {
			t(),
